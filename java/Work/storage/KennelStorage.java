...
import Work.Animals.implement.*;
import Work.Animals.Skill;
...
public class KennelStorage implements Storage{
    ...
    private void init(){
        ...
        Pack_Animals horse = new Horse("Гнедой", LocalDate.of(2021, 2, 4));
        horse.setLoadCapacity(300);
        horse.learnSkill(new Skill("Галоп!"));
        dbAnimals.put(horse.getId(), horse);

        Pack_Animals horse2 = new Horse("Гнедой_2", LocalDate.of(2022, 12, 1));
        ...
        Pack_Animals donkey = new Donkey("Тупица", LocalDate.of(2020, 8, 24));
        donkey.setLoadCapacity(500);
        donkey.learnSkill(new Skill("Поклон!"));
        dbAnimals.put(donkey.getId(), donkey);

        Pack_Animals camel = new Camel("Рыжий", LocalDate.of(2020, 5, 20));
